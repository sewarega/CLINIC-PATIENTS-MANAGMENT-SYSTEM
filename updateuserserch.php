...
<table  >
	...
	<tr>
	<table  bgcolor="#E0FFFF"width="140" height="400" ><tr><td bgcolor="#808080">
...
<ul id="menu1">
	...
	<li> you are  on Search Update User page</li>
	<li><a href="Admin.php">Back</a></li><br />
    </h5>             			
	<div  class="flt rp_block" style="margin-left:20px;">
 
	  <div style="margin-left:20px;">
		<span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Search Update User From Database </span><br />
						
       <form id="form1" name="login" method="POST" action="updateuser.php" onsubmit="return validateForm()">
