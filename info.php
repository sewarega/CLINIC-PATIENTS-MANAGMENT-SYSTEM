...
<br><center>
						<span style="font-family:cambrian;color:#006699;font-size:27px;">All patient labratory detail information</span><br />
...
?>
		<table  class="table" border="" width="500px" align="left"style="margin-left:0px;"> <!--class="table table-bordered"-->
              ...
              <tbody>
			  <?php 
				$result = mysql_query("SELECT * FROM labresulttable");
				
				while($data = mysql_fetch_object($result) ):
			  ?>
                <tr>
				<td><?php echo $data->labresult_id?></td>
                  <td><?php echo $data->patient_id?></td>
                  <td><?php echo $data->labresultdes?></td>
				  <td><?php echo $data->ltdate?></td>
