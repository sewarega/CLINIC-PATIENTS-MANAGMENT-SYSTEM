...
<table  width="150" >
	...
	<tr>
	<table  bgcolor="#E0FFFF"width="130" height="850" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
     ...
     <center>
        <div id="slider"> 		
            <img src="slideshow/images/c.jpg" alt="Amocsasiline" />
            <img src="slideshow/images/im1.jpg" alt="Parastamol" />
            <img src="slideshow/images/d13.jpg" alt="Stringe" />
            <img src="slideshow/images/im.jpg" alt="The collection of drug" />
...
<div id="cover">
      ...
      <!--<div >
				<ul id="menu1">
				<li><a href="home.php" class="current">Home</a></li>
        	<li><a href="about.php" class="current">About As</a></li>
          	<li><a href="contact.php" class="current">Contact As</a></li>
			<li><a href="feedback.php" class="current">Feedback</a></li>
            	<li><a href="login.php" class="current">login</a></li>
			</ul>
		</div>-->
    <div id="main1">
		<div id="content">
		  <div class="flt1 cpinner">
		  		<div class="flt1 lp_boxbg" style="background-color:brown;margin-right:1px"> <br/></br>
				<img src="images/login.jpg"  height="10" width="150px">
		  </div>
