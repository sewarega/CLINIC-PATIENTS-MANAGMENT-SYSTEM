...
<table >
	...
	<tr>
	<table  bgcolor="#E0FFFF"width="146" height="580" ><tr><td bgcolor="#808080">
...
<li> you are on search prescripition page</li>
<li><a href="doctorpage.php">Back</a></li><br />
 ...
 <div style="margin-left:20px;">
		<span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Filter From Database </span><br />
						
       <form id="form1" name="login" method="POST" action="priscriptionform.php" onsubmit="return validateForm()">
 <table width="430px" valign="top" align="left">
  <tr>
<td class='para1_text' width="120px"><font color="red"></font> <b>pateint ID No.</b></td>
