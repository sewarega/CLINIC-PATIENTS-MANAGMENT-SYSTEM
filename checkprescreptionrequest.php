...
<table  >
	...
	<tr>
	<table bgcolor="#E0FFFF"width="150" height="530" ><tr><td bgcolor="#808080">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg"> 
           <h6 align="left">
					...
					<li> you are  on check prescreption request page</li>
        ...
        <br />
          <li><a href="pharmacyreport.php">Generate Report</a></li>
						<li><a href="checkprescreptionrequest.php">Check request</a></li>
						<li><a href="drugregister.php">Deliver drug</a></li>
		  </div>

			<div  class="flt rp_block" style="margin-left:0px;">
     <div class="logi" style="margin-left:20px;">

							<h4> Check Prescription Drug request </h4>
       <form id="form1" name="login" method="POST" action="checkprescreptionrequest.php" onsubmit="return validateForm()">

<p style="font-size:14px;font-family:cambrian;color:black;" >
If you wants to know check apatient that have an a prescreption request information by using searching patient ID No.</p></br>
  <center> <table width="399px" valign="top" align="center">
  <tr>
<td class='para1_text' width="200px"><font color="" > <b>Patient ID</b></font></td>
<td><SPAN><input type="text"  name="apsdate" placeholder="Enter ID"  size="px" required x-moz-errormessage="Please enter patient id No"></SPAN></td>
...
if(isset($_POST['search']))
 {
					...
					$sql="SELECT * FROM prescriptiontable  WHERE  patient_id = '$apsdate' ORDER BY presc_no DESC LIMIT 1";
					...
					echo"<br>";
echo "<table  class='table' style='width:350px;height:50px;border-radius:10px;border-radius:10px;border:px solid #336699' align=''>
<tr >
<th colspan='8' align='center'><h4>&nbsp;&nbsp;&nbsp;Prescription Request information about Drug</h4.</th>
</tr>
<tr height='30px'>

<th bgcolor=''><font color='black'>Patient_Name</th>
<th bgcolor=''><font color='black'>Patient_ID</th>
<th bgcolor=''><font color='black'>Rx/Kinds.drug</th>
<th bgcolor=''><font color='black'>Diagnosis</th>
<th bgcolor=''><font color='black'>Pres_D/Name</th>
<th bgcolor=''><font color='black'>Date_of_request</th>
