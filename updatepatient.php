    ...
    <div id="main1">
		<div id="content">
		 <div class="flt1 cpinner">
					...
					<li> update patient page</i>
					<li><a href="searchupdate.php">Back</a></li><br />
    </h6>
    </h6>	<div  class="flt rp_block" style="margin-left:40px;">	
	<center>
<div style="width:750px;height:50px;border:1px #ebf5ac solid;border-top-left-radius:8px;
border-top-right-radius:8px;border-bottom-left-radius:8px;border-bottom-right-radius:8px;margin-top:1px;"><br>
<font style="font-family: monotype corsiva, Helvetica, sans-serif;color:#006699;font-size:30px;"><b>Update Patient Profiles</b></font>
</div></br></br>		
<?php
include("config.php");	
?>
<table class="table" style='width:350px;height:50px;border-radius:10px;border-radius:10px;border:px solid #336699' align='center'> <!--class="table table-bordered"-->
              <thead>
                <tr height='30px'>
                  <th>Patient_ID</th>
                  <th>FName</th>
...
if(isset($_POST['search'])):
			  ...
			  ?>
                <tr>
				  ...
				  <td>
					<a href="updatepatientBYID.php? patient_id=<?php echo $data->patient_id ?>">
						<button class="btn btn-info" type="button"  name="Submit" onclick="return confirm('You Are Going to Update Record!!')"> Edit </button>
					</a>
				  </td>
				   <td>
					<a href="deletepatientById.php?patient_id=<?php echo $data->patient_id ?>">
