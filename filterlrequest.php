...
<div id="cover">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg" style="background-color:white;margin-top:12px;">
					...
					<li> you are  on lab request page</li>
 ...
 <div style="margin-left:20px;">
       ...
       <form id="form1" name="login" method="POST" action="LabRequestForm.php" onsubmit="return validateForm()">
<p style="font-size:15px;color:black;font-family: campria;" >if you wants to make prescription to labratory first select patient by using  patient Id.</p>
...
$res=mysql_query("INSERT INTO labrequesttable(patient_id,age,sex,plan,pdname,sign,date) values('$pid','$age','$sex','$plan','$pdname','$sign','$date')");
if($res )
	{

echo "<font face='arial' align='left' color='black' size='4'><img src='img/tick.png' width='25px' height='25px'>&nbsp;&nbsp;your Laboratory patient Requesting succefully registered !!!</font>";
echo' <meta content="10;filterlrequest.php" http-equiv="refresh" />';
	}
	else
	{
