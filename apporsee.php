...
<table>
	...
	<tr>
	<table bgcolor="#E0FFFF"width="100" height="500" ><tr><td bgcolor="#808080">
...
<div id="cover">
      ...
      <div >
			<ul id="menu1">
				...
				<ul style="margin-left:10px;padding-right:4px;">
								<li><a href="apporsee.php">See appointment Request</a></li>
...
<span class="flt1 lp_txtour">our solutions</span><br />
     ...
     <span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Appointment Request</span><br />
						
       
	  <?php
$conn=mysql_connect("localhost","root","");
$db1=mysql_select_db("Auclinic_database",$conn);
$result ="SELECT * FROM appo ";//AND drugtable.expire_date <= DATE_ADD(DATE(now()), INTERVAL 4 WEEK)
$res=mysql_query($result);
if(mysql_num_rows($res)>0)
{
echo "<table style='width:300px;height:50px;border-radius:10px;border-radius:10px;border:1px solid #336699' align='left'>
<tr bgcolor='silver'>

<th bgcolor=''><font color='black'>Patient_ID</th>
<th bgcolor=''><font color='black'>Appointment_Date</th>
<th bgcolor=''><font color='black'>Doctor/Nurs Name</th>
...
echo"<td >&nbsp;&nbsp;<a href=deleteappo.php?id=".$row['patient_id']."><img src='img/5.JPG' width='25px' height='20px' onclick='isdelete();' title='Delete Button'></a></td>";
...
echo "</table>";
   ...
   echo '<center>';
  echo '<font face="monotype corsiva" size="5"color="red">No Appointment Request!!</font>';
