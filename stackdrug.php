...
<table >
	...
	<tr>
	<table bgcolor="#E0FFFF"width="200" height="580" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
		...
		<h6 align="left">
					...
					<li> you are  on stack drug page</li>
    </h6>
...
<center>
     ...
     <div class="login" style="margin-left:20px;">	
       ...
       <form id="form1" name="login" method="POST" action="stackdrugpage.php" onsubmit="return validateForm()">
