...
<table>
	...
	<tr>
	<table bgcolor="#E0FFFF"width="135" height="480" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg"> 
					...
					<li> you are  on search patient</li>
 ...
 <div style="margin-left:20px;">
						<span style="font-family: campria;color:#006699;font-size:25px;">Select Patient From Database</span><br />
						
       <form id="form1" name="login" method="POST" action="appointment.php" onsubmit="return validateForm()">
<p style="font-size:14px;color:black;font-family: campria;" >if you wants to register patient appointment date first select patient by using your patient Id.</p>
...
$apedate=$_POST['apedate'];
$aptime=$_POST['aptime'];
$dname=$_POST['dname'];
$res=mysql_query("INSERT INTO appointment(fname,lname,patient_id,apsdate,apedate,aptime,dname) values('$fname','$lname','$pid','$apsdate','$apedate','$aptime','$dname')");
if($res )
	{
		echo "<br>";
echo "<font color='black' size='4'><img src='img/tick.png' width='25px' height='25px'>&nbsp;&nbsp;<p >Appointment succefully registered !!!</p></font>";
echo'<meta content="7;serchpatient.php" http-equiv="refresh" />';
	}
	else
	{
	echo"<font color='black' size='4'><img src='img/error.png' width='20px' height='20px'>&nbsp;<p class='right'>The opration failed Please try again</p></font>";
	}
	}
mysql_close($conn);
?>
