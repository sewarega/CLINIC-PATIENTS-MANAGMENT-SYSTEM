...
<table >
	...
	<tr>
	<table bgcolor="#E0FFFF"width="150" height="600" ><tr><td bgcolor="#808080">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg" style="background-color:white;"> 
            ...
            <h6 align="left">
					...
					<li> you are  on pharmasist page</li>
					<li><a href="login.php">back</a></li>
    </h6>
              
            
<br/><br/> <span style="font-family: monotype corsiva, Helvetica, sans-serif;color:#006699;font-size:25px;"><b>The duties pharmasists</b></span><br /><br />While responsibilities vary among the different areas of pharmacy practice, the bottom line is that pharmacists help patients get well. Pharmacist responsibilities include a range of care for patients, from dispensing medications to monitoring patient health and progress to maximize their response to the medication.
...
border-bottom-right-radius:8px;border-bottom-left-radius:8p;margin-left:60px;"> </br>

<font  size="4px"color="#435000"><b>Well Come To Pharmacy Page </b></font> </br> </br>
