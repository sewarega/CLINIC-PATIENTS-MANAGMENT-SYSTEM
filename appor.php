...
<li>logged as <?php print($FirstName); ?> <?php print($LName); ?>  || <a href="logout.php">Logout</a></li>
              <br>
			  <li><a href="appor.php">Send Appointment request</a></li>
            <li><a href="info.php">View Detail Patient Lab info</a></li>
			 <li><a href="infopharm.php">View Detail Patient Lab info</a></li>
			</div>
...
<span style="font-family: ;color:#212b00;font-size:23px;"><font color="#212b00">Appointment Request</font></span> </br> 
...
$date=$_POST['date'];
$pname=$_POST['pname'];
$res=mysql_query("INSERT INTO appo(patient_id,date,pname) values('$id','$date','$pname') ");
if(!$res)
	{
echo"<font size='4px' color='red'><p class='wrong'>Insertion failed</p></font>";
echo' <meta content="8;appor.php" http-equiv="refresh" />';
	}
	else
	{

echo"<font size='4px' color='green'><img src='img/tick.png' width='25px' height='25px'>&nbsp;&nbsp;<p class='right'>Request send succefully!!!</p></font>";
echo' <meta content="7;appor.php" http-equiv="refresh" />';
	}
}
...
<form action="appor.php" method="post"  name="form1" id="form1" onsubmit="return checkvalidation()"><br/>

<table>
<tr><td><font color="#212b00" size="3">Patient_ID:</font></td><td>
<input type="text" name="patient_id" required/></br> </br></td></tr>

<tr><td><font color="#212b00"  size="3">Appointment_Date:</font></td><td>
<input type="text" name="date" class="tcal" id="dname" required/></br></br> </td></tr>
<tr><td><font color="#212b00" size="3">Doctor Name:</font></td>
<td ><input type="text" name="pname" id="pname" value="<?php echo $FirstName . " " . $LName ?>" required="required">
   </td>              
</tr>
   

</table></br></br>
<p align="right" id="btn-small" ><input class="button_example"style=margin-left:10px; type="submit" name="Submit" value="Send" />
