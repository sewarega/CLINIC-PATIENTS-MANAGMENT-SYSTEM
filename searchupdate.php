...
<table >
	...
	<tr>
	<table bgcolor="#E0FFFF"width="130" height="400" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg"> 
					...
					<li> you are on search patient for updation</li>
	  ...
	  <div style="margin-left:20px;">
		<span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Filter Patient From Database </span><br />
						
       <form id="form1" name="login" method="POST" action="updatepatient.php" onsubmit="return validateForm()">
