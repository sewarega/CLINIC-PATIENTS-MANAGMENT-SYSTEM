...
<table width="200">
	...
	<tr>
	<table bgcolor="#E0FFFF"width="148" height="700" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg"> 
					...
					<li> search patient to give card page</li>
	  ...
	  <div style="margin-left:20px;">
		<span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Give Card To Patient </span><br />
						
       <form id="form1" name="login" method="POST" action="card.php" onsubmit="return validateForm()">
 <table width="499px" valign="top" align="left">
  <tr>
<td class='para1_text' width="00px"><font color="red"></font> <b>Patient ID No.</b></td>
...
<p align="right"><a href="#"  onClick="printF('printData')" title="Print this page">
	<img src="img/print_icon.JPG" width="40px" height="40"></a></p>
<div id="printData"></br>
<div   style="margin-left:90px;width:340px;">
		...
		<?php
		 ...
		 if(isset($_POST['search']))
              {
		$pid=$_POST['dayfrom'];
		$results = mysql_query("SELECT * from patient_table where patient_id='$pid'");
		while($row=mysql_fetch_array($results))
		{
            $fname=$row['fname'];
			$lname=$row['lname'];
			$page=(Date('Y-m-d'))-($row['age']);
			$psex=$row['sex'];
			$dept=$row['department'];
			$pid=$row['patient_id'];
			echo "<center><p><font size='4'><b>AU University Clinic Information Managment System <font></p></center>";
			
             echo "<center><p><font size='4'><b>Patient Card <font></p></center>";
			 echo "<center><p><font size='4'>-------------------------------------------------------- <font></p></center>";
            
			 echo "<center>";
			echo "<br>";
			echo"<tr>
			  <td><b>Patient Name: &nbsp;&nbsp;&nbsp;</b>{$fname}&nbsp;&nbsp;&nbsp;{$lname}</td>
			     </tr>
				 ";
			echo"<tr>
			<td><b>Age: &nbsp;&nbsp;&nbsp;</b>{$page}</td>
...
echo(Date(" F d,Y"));
?></td></tr>
		</table><br><hr><p align="right"> Au IoT Clinic Office:</p>
