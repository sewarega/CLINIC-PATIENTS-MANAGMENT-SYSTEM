...
<table  width="130" >
	...
	<tr>
	<table bgcolor="#E0FFFF"width="130" height="380" ><tr><td bgcolor="#808080">
...
<ul id="menu1">
	...
	<h6 align="left">
					...
					<li> you are  on search user page</li>
					<li><a href="Admin.php">Back</a></li><br />
    </h6>	 
                   			<div  class="flt rp_block" style="margin-left:20px;">
 
	  <div style="margin-left:20px;">
		<span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Search From Database </span><br />
						
       <form id="form1" name="login" method="POST" action="searchuser.php" onsubmit="return validateForm()">
 <table width="430px" valign="top" align="left">
  <tr>
<td class='para1_text' width="120px"><font color="red"></font> <b>User ID No.</b></td>
...
if(isset($_POST['search']))
 {
					...
					echo"<center>";
					echo"<br><br>";
					echo('<font color="red" size="4px"> This user id number is not found &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>');
...
<tr>
<th bgcolor=''><font color='black'>user_id</th>
<th bgcolor=''><font color='black'>User_Name</th>
<th bgcolor=''><font color='black'>Sex</th>
<th bgcolor=''><font color='black'>Age</th>
<th bgcolor=''><font color='black'>Mariage</th>
<th bgcolor=''><font color='black'>Address</th>
<th bgcolor=''><font color='black'>Salary</th>
<th bgcolor=''><font color='black'>Phane_No.</th>
<th bgcolor=''><font color='black'>Email</th>
<th bgcolor=''><font color='black'>Postion</th>
</tr>";
while($row = mysql_fetch_array($cha1))
  ...
  print ("<td>" . $row['sex']. "</td>");
  print ("<td>" . $aa. "</td>"); 
  print ("<td>" . $row['mariage_status']. "</td>"); 
