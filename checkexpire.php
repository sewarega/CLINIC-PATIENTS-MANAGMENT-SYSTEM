...
<script>
  function isdelete()
  {
   ...
   if(!d)
   {
    alert(window.location='checkexpire.php');
   }
   else
   {
   return false;
...
<table width="150">
	...
	<tr>
	<table bgcolor="#E0FFFF"width="150" height="700" ><tr><td bgcolor="#808080">
		...
		<div id="content">
           <div class="flt1 cpinner">
			 ...
			 <h6 align="left">
					...
					<li> you are  on check expire date page</li>
					 <li><a href="pharmacist.php">Back</a></li><br />
    </h6>
			 <br />
          
		  <img src="img/a12.JPG" class="img-circ"width="200px" height="200px"><br>
		  </div>
       <div  class="flt rp_block" style="margin-left:0px;"></br>
         <div class="content" style="margin-left:110px">
               
			   <font face="cambria" size="4" color="red"><b>Expired drug List in pharmacy</b></font>
...
$result ="SELECT * FROM drugtable where  drugtable.expire_date <= DATE(now()) ";//AND drugtable.expire_date <= DATE_ADD(DATE(now()), INTERVAL 4 WEEK)
$res=mysql_query($result);
if(mysql_num_rows($res)>0)
{
echo "<table style='width:300px;height:50px;border-radius:10px;border-radius:10px;border:1px solid #336699' align='center'>
<tr bgcolor='silver'>
<th  border='1' height='30' bgcolor=''><font color='black'>Drug Code</th>
...
<th bgcolor=''><font color='black'>Unit</th>
<th bgcolor=''><font color='black'>Shelf_No.</th>
...
echo"<td >&nbsp;&nbsp;<a href=deletedrug.php?id=".$row['dcode']."><img src='img/5.JPG' width='25px' height='20px' onclick='isdelete();' title='Delete Button'></a></td>";
...
echo "</table>";
   ...
   echo '<center>';
  echo '<font face="monotype corsiva" size="5"color="red">Expired(Outdated) drug not found in data base!!</font>';
