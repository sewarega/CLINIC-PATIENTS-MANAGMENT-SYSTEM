...
<table width="200">
	...
	<tr>
	<table bgcolor="#E0FFFF"width="300" height="520" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
     ...
     <div class="login" style="margin-left:20px;">
	 	 <h1><span style="font-family: monotype corsiva, Helvetica, sans-serif;color:#006699;font-size:30px;">View Patient History</span></h1>
       <form id="form1" name="login" method="POST" action="generalreportpag.php" onsubmit="return validateForm()"> 	
<p style="font-size:14px;color:blue;" >if you wants to View particular patient history by using searching Patient_ID.</p>
   <table width="399px" valign="top" align="left"> 
  <tr>
<td class='para1_text' width="200px"><font color="red"></font> Patient_ID No.</td>
<td><input name="dayfrom" type="text" placeholder="BRT/0000/08" required x-moz-errormessage="Please enter correct id"/></td>	
