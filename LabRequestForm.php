...
<table border="" width="200" >
	...
	<tr>
	<table  bgcolor="#E0FFFF" width="147" height="655" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
		...
		<h6 align="left">
					...
					<li> you are  on lab request form page</li>
					<li><a href="filterlrequest.php">Back</a></li><br />
    </h6>
...
<li><a href="stackoutDesise.php">Labratory Refer</a></li>
						<li><a href="stackdrug.php">Drug Refer</a></li>
						<li><a href="LabRequestForm.php">Lab request</a></li>
						<li><a href="checklabresult.php">Check lab result</a></li>
						<li><a href="priscriptionform.php">Priscription </a></li>
...
if(isset($_POST['search']))
 {
					...
					echo'<meta content="5;filterlrequest.php" http-equiv="refresh" />';
					}
					else
					{
					$result = mysql_query("SELECT * FROM patient_table WHERE patient_id='$pid'");
			         $data = mysql_fetch_object( $result ); 
                          ...
                          ?>
			<form action="filterlrequest.php" method="post" name="abc" onSubmit="return validateForm()">
<span style="font-family:campria;color:#006699;font-size:24px;">Laboratory Requesting  Form</span><br />
					
			  <table width="500px"  >
  <tr>
    <td colspan="2"><div style="font-family:monotype corsiva, Helvetica, sans-serif;color:black; font-size:25px;">All Field must be filled up</div></br></td>
  </tr></br>
   <tr width="">

        <td > <input type="hidden" name="card_no" id="card_no" required="required"  disabled="disabled">

      </tr>
  <tr>
  <td width="120" valign="top"><div align="right">Patient ID:</div></td>
        <td width="236"><input type="text" value="<?php echo $data->patient_id ?>" name="patient_id" id="patient_id" required="required" ></td>

        </td>
      </tr>
	  <tr>
  <td  width="12" valign="top"><div align="right">Age:</div></td>
       <td >
		<input type="text" name="age" value="<?php echo Date('Y-m-d')-$data->age ?>"   required/></br>
		</td>
		</tr>
		<tr>
      <td  width="12" valign="top"><div align="right">Sex:</div></td>
		<td><input type="radio"  name="sex" value="male" title="choose either male by clicking here" required />Male
                         <input type="radio" name="sex" value="female" title='choose female by clicking here' required /> Female</br></br>   </td>
      </tr>

			  <tr >
                <td width="150" valign="top"><div align="right">Plan:</div></td>
                <td> <select id="plan" name="plan"  required>
					   <option value="it">Select plan</option>
					   <option >WFT</option>
					   <option>BT</option>
					   <option>WF</option>
					   <option>HCG</option>
					   ...
					   <option>HB,Agl test</option>
					   <option>AFB 3X</option>
					   <option>U/A</option>
			  ...
			  <tr>
                ...
                <td colspan="2"><input type="text" name="pdname" id="pdname" value="<?php echo $FirstName . " " . $LName ?>" required="required">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <td><input type="text" name="date" id="ddate" class="tcal"  required="required"></br></td></br></br></br></br>
