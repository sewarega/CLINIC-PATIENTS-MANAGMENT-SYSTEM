...
<table width="150">
	...
	<tr>
	<table bgcolor="#E0FFFF"width="130" height="650" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg"> 
			<h6 align="left">
					...
					<li> you are  on lab report page</li>
 ...
 <div style="width:500px;height:450px;border:px #7a7b78 solid;float:right;margin-right:150px;margin-top:50px ">
<center>
<div style="width:600px; background-color:white silver;border:1px #b0c248 solid;border-top-right-radius:8px;border-top-left-radius:8px;
border-bottom-right-radius:8px;border-bottom-left-radius:8px"></b><br/>
<font face="cambria, Helvetica, sans-serif" color="#435000"><b>GENERAL LABRATORY REPORT IN SPECIFIED RANGE </font></b></b><br/><br/>
<div style="width:500px;background-color:;border:1px #ebf5ac solid;border-top-right-radius:8px;border-top-left-radius:8px;
border-bottom-right-radius:8px;border-bottom-left-radius:8px;height:150px; ">
<center>
<form action="labreportpage.php" method="post"><br/>
<h3> <font color="#006699" face="cambria, Helvetica, sans-serif">MONTH OVERVIEW</font></h3>


FROM:&nbsp;<input name="dayfrom" type="text" class="tcal" placeholder="Start Date...." required/>
TO:&nbsp;<input name="dayto" type="text" class="tcal"  placeholder="End Date.." required/>
<br><br>
<input name="Submit" type="submit"  class="button_example" value="View report"/><br/><br/>
</form>
 </center>
...
<b>---------------------------------------------<br/>
AU IoT Clinic Information Management System</b>
</font>
