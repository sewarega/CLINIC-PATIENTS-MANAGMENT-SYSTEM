...
<table width="150">
	...
	<tr>
	<table bgcolor="#E0FFFF"width="150" height="610" ><tr><td bgcolor="#808080">
    ...
    <div id="main1">
		<div id="content">
		  		...
		  		<div class="flt1 lp_boxbg" style="background-color:white;"> 
					...
					<li> you are  on search appontement page</li>
		...
		<span class="flt1 lp_txtour">our solutions</span><br />
         <span class="flt1 lp_boxtxt">You may conduct your pharmacy operations in one of our clinic. has employed the top security for various 
		  transactions.  </span><br /><br/><br/><hr>
<img src="img/ma.JPG" class="img-circ"width="200px" height="150px"><br>
		  <img src="images/lp_ashsqr.jpg" width="3" height="3" alt="" class="flt1 lp_boxbult" />
		  <a href="searchpa.php" class="flt lp_boxtxt2">search Patient</a> 
		  </div>
					<div  class="flt rp_block" style="margin-left:10px;">	
  <div class="login" style="margin-left:20px;">
<span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Check Patient Appointment Date </span><br />
       <form id="form1" name="login" method="POST" action="searchappo.php" onsubmit="return validateForm()">
  	
<p style="font-size:14px;color:black;font-family:cambrial" >if you wants to check patient appointment date information by using searching Date.</p>
   <table width="399px" valign="top" align="left">
  <tr>
<td class='para1_text' width="200px"><font color="red"></font> Appointment Date.</td>
<td><input name="dayfrom" type="text" class="tcal" placeholder="Start Date...." required x-moz-errormessage="Please enter appointment start date"/></td>
...
if(isset($_POST['search']))
 {
					$pid=$_POST['dayfrom'];
					$sql= "SELECT * FROM appointment where apsdate='$pid'";
					...
					echo"<center>";
					echo"<br><br>";
					echo('<font color="red" size="4px">Please enter correct appointment date</font>');
					echo'<meta content="5;searchappo.php" http-equiv="refresh" />';
					}
					else
					{
					echo"<center>";
