...
<table width="150">
	...
	<tr>
	<table bgcolor="#E0FFFF"width="150" height="750" ><tr><td bgcolor="#808080">
   ...
   <div >
    ...
    <div id="main1">
		...
		<h6 align="left">
					...
					<li> you are  on view drug page</li>
					 <li><a href="pharmacist.php">Back</a></li><br />
    </h6>
          <br />
         
		  <img src="img/d1.JPG" class="img-circ"width="180px" height="170px"><br><hr>
		  		  <img src="drug/image.JPG" class="img-circ"width="180px" height="170px"><br><hr>
		  </div>
		
			<div  class="flt rp_block" style="margin-left:0px;">
<br>              <div class="content">
               <center>
<span style="font-family:campria;color:#006699;font-size:25px;">Drug List in pharmacy</span><br />
...
$result = mysql_query("SELECT * FROM drugtable");
if(mysql_num_rows($result)>0)
{

echo "<table  class='table' style='width:280px;height:50px;border-radius:10px;border-radius:10px;border:1px solid #336699' align='center'>
<tr bgcolor=''>
<th  border='1' height='40' bgcolor=''><font color='black'>Drug Code</th>
...
<th bgcolor=''><font color='black'>shelf No.</th>
