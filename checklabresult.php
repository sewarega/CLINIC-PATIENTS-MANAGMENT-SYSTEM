...
<table  >
	...
	<tr>
	<table bgcolor="#E0FFFF"width="200" height="500" ><tr><td bgcolor="#808080">
...
<div id="cover">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg"> 
					...
					<li> you are  on check lab result page</li>
              <li><a href="doctorpage.php">Back</a></li><br />
		<br />
           </tr>
		 <li><a href="serchprescription.php"><b>Priscription </b></a></li>
						<li><a href="filterlrequest.php"><b>Lab request<b></a></li>
						<li><a href="checklabresult.php"><b>Check lab result<b></a></li>
     ...
     <div  style="margin-left:10px;">		
							...
							<span style="font-family:campria;color:#006699;font-size:24px;">Select Patient From Database</span><br />
					
       <form id="form1" name="login" method="POST" action="checklabresult.php" onsubmit="return validateForm()">
  	
<p style="font-size:15px;font-family:cambria;color:black;" >
If you wants to know check apatient that have Laboratory Result Test information by using searching patient ID No.</p></br>
   <table width="399px" valign="top" align="left">
  
  <tr>
<td class='para1_text' width="200px"><font color="" > <b>Patient ID</b></font></td>
<td><SPAN><input type="text"  name="apsdate"   size="px" required x-moz-errormessage="Please enter patient id No"></SPAN></td>
...
if(isset($_POST['search']))
 {
					$apsdate=$_POST['apsdate'];
					$sql="SELECT * FROM labresulttable  WHERE  patient_id = '$apsdate' ORDER BY labresult_id DESC LIMIT 1";
					...
					echo"<center>";
					echo"<br><br>";
echo "<table class='table' style='width:300px;height:50px;border-radius:10px;border-radius:10px;border:1px solid #336699' align='left'>
<tr >
<th align='center' colspan='8'><h4>Labratory Result Request information </h4.</th>
</tr>
<tr height='30px' bgcolor='silver'>
<th bgcolor=''><font color='black'>Patient_ID</th>
<th bgcolor=''><font color='black'>Lab_result</th>
<th bgcolor=''><font color='black'>Lab_technician_name</th>
<th bgcolor=''><font color='black'>Date_of_Test</th>
<th bgcolor=''><font color='black'>Sign</th>
</tr>";
