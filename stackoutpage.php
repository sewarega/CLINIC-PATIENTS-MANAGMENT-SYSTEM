...
<table >
	...
	<tr>
	<table bgcolor="#E0FFFF"width="147" height="810" ><tr><td bgcolor="#808080">
    ...
    <div id="main1">
		...
		<div class="flt1 lp_boxbg" style="background-color:white;margin-top:12px;">
		 ...
		 <li>you are on stack out page</li>
              <li><a href="stackoutDesise.php">Back</a></li><br />
...
<div id="printData">
<center>
<img src="Ambo.jpg" class="img-circ"width="100px" height="100px">
...
Created ON:<?php echo(Date(" F d,Y"));?> <br/><br/></font></b></div>
<br/>
</div></center>
<center><b>AU IOT Clinic Labratory Refer</b></center> 
<div   style="margin-left:30px;width:540px;">
 ...
 {
					$pid=$_POST['dayfrom'];
		$results = mysql_query("SELECT * from labrequesttable  where patient_id='$pid' ORDER BY  card_no DESC LIMIT 1");
		$result = mysql_query("SELECT fname,lname from patient_table  where patient_id='$pid'");
		...
		while($row=mysql_fetch_array($results))
		{
			...
			echo"<tr>
			  <td><b>Patient Sickness Condition(Plan):&nbsp;&nbsp;&nbsp;</b>{$plan}</td>
			     </tr>
				 ";
			echo"<tr>
			...
			echo"<tr>
			<td><b>Priscriber Signature:&nbsp;&nbsp;&nbsp; </b>_________________________</td>
			</tr>";
		}
 }
		...
		?>
  		...
  		<font color="#435000" size="2" align="center"face="Arial, Helvetica, sans-serif">
<b>---------------------------------------------<br/>
