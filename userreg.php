		...
		<div id="content">
		 ...
		 <div class="flt1 lp_boxbg"> 		
          ...
          <h6 align="left">
					...
					<li> you are  on user register page</li>
    </h6>
...
<li><a href="monitoraccount.php">Control Account</a></li>
			  <li><a href="accoutadmin.php">Create Account</a></li>
			<li><a href="deleteAccount.php">Delete Account</a></li><br />
	...
	<span style="font-family: cambria, Helvetica, sans-serif;color:#006699;font-size:23px;">Employee Registration Form </span><br />
	<?php
	include("body/userreg.php");
     ?>
                   <div class="desk" style="margin-left:60px;">
				   <form  name="myform" method="post" enctype="multipart/form-data"  action="userreg.php" onsubmit="return checkvalidation()" >
	  	<P style="font-family:15;"> First Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="fname" id="fname"  onkeypress="return chkAplha(event,'error12')" onblur="chkblnk('fn','error12')" required/></br>
		last Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="lname"id="lname"  onkeypress="return chkAplha(event,'error11')" onblur="chkblnk('fn','error11')" required/></br>
		 User ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="user_id" id="id" onKeyPress="return onlyNum(event)" required/></br>
		Sex:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<p><label for="text_field">BirthDate:</label>
							 <select style="width: 100px;" name="birthday_month" id="month" onChange="return run_with(this, [&quot;editor&quot;], function() {editor_date_month_change(this, &quot;birthday_day&quot;, &quot;birthday_year&quot;);});">
		...
		Civil Stutus:&nbsp;&nbsp;&nbsp;&nbsp;
					<select id="relation" name="mariage_status" required>     
					<option value="-1">Relationship</option> <option>Single</option>
					               <option>Married</option>
                                <option>In a relationship</option>
                                <option>Widow</option>
                                <option>Seperated</option></select></br>
		
	    Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input  type="text" placeholder="Input Address"  name="address"  id="address"  required/></br>
		Phone No:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="phone_no"  id="phone_no"  value="09"maxlength="10" onKeyPress="return nlyNum(event)" /></br>
		Salary:&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="salary"  id="salary" width="100px" onKeyPress="return onlyNum(event)" required/></br>
		Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="email"  id="email"required /></br>
		User Type:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<select name="user_type" id="user_type" onkeypress="return chkAplha(event,'error12')" onblur="chkblnk('fn','error12')"required>
			  <option value="-1">User_type</option>Admin

			  <option>Doctor</option>
			  <option >Pharmasist</option>
			  <option>Lab tecnitian</option>
			  <option>Clerk</option>
			  <option>Admin</option>
			</select></br>
	   User Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="user_name" id="user_name"  onkeypress="return chkAplha(event,'error12')" onblur="chkblnk('fn','error12')" required/></br>		
	   <p>Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="password" name="Password" id="Password"  onkeyup="passwordStrength(this.value)"required/>
		<span id="passwordDescription"></span>
        <span id="passwordStrength" class="strength0"></span></p>
		
       Verify Passsword:<input type="password" name="confirm_assword" id="confirm_assword"  onkeypress="return chkAplha(event,'error12')" onblur="chkblnk('fn','error12')" required/></br>
</br>
                                       
        <p class="submit" align="center"> 
		<input class="button_example" type="submit" name="Register" value="Register"  />
		<input  class="button_example" type="reset" name="reset" value="Reset"  onClick="refresh()align ="center"/>
		</p>
		</form>
	  </div>
